...
```json
{
  "applicationName" : "weather-rick",
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=rroque99&repo=weather",
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->weather-rick]
...
┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'weather-rick.csproj'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=rroque99&repo=weather'
